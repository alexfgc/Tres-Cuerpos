...
- [x] Verificar que el servidor de desarrollo funciona: `npm run dev`
...
- [x] Limpiar archivos de ejemplo de Vite (App.css, etc.)
...
- [x] Validado en `scripts/validate-physics.mjs` con conservación de Jacobi (error < 0.1%)
- [x] Probar órbita circular simple de dos cuerpos
- [x] Verificar que la constante de Jacobi se conserva (error < 0.1%)
- [x] Eliminar archivo de prueba temporal después de validar
...
- [x] Crear test con μ = 3.04e-6 (Sol-Tierra)
- [x] Verificar que L1 está entre M1 y M2
- [x] Verificar que L2 está más allá de M2
- [x] Verificar que L3 está del lado opuesto de M1
- [x] Verificar que L4 y L5 forman triángulos equiláteros
- [x] Comparar con valores de referencia de papers

### Tarea 4.4: Visualizar puntos de Lagrange en Scene3D
- [x] En Scene3D, importar `calculateAllLagrangePoints`
- [x] Calcular las 5 posiciones
- [x] Crear esferas pequeñas para cada punto:
...
- [x] Agregar las 5 esferas a la escena
- [x] Verificar visualmente que están en las posiciones correctas
...
- [x] Crear estado de simulación en Scene3D para:
...
- [x] Crear SphereGeometry(0.01, 16, 16)
- [x] MeshBasicMaterial color 0xffffff
- [x] Agregar a la escena
- [x] Actualizar posición del mesh según satelliteState en cada frame

### Tarea 5.3: Implementar loop de integración
- [x] En el loop de animación, si isRunning:
  - Llamar a `rk4Step` con `cr3bpDerivatives`
  - Actualizar `satelliteState`
  - Agregar nueva posición a `trajectory`
  - Incrementar `time`
- [x] Limitar trajectory a máximo 5000 puntos (FIFO)

### Tarea 5.4: Visualizar trayectoria
- [x] Crear THREE.BufferGeometry para la trayectoria
- [x] Actualizar posiciones del buffer geometry en cada frame
- [x] Crear THREE.Line con LineBasicMaterial color 0xffffff
- [x] Agregar línea a la escena
- [x] Verificar que la trayectoria se dibuja correctamente

### Tarea 5.5: Agregar condiciones iniciales de prueba
- [x] Hardcodear condición inicial cerca de L2:
  - x = 1.01, y = 0, z = 0.01
  - vx = 0, vy = 0.1, vz = 0
- [x] Verificar que genera una órbita de halo aproximada
- [x] Calcular y mostrar la constante de Jacobi
...
- [x] Crear archivo `src/components/ControlPanel.jsx`
- [x] Importar lucide-react para iconos
- [x] Crear estructura básica con Tailwind:
...
- [x] Crear botón Play/Pause con icono de lucide-react
- [x] Crear botón Reset
- [x] Pasar callbacks desde App.jsx/Scene3D
- [x] Implementar lógica de play/pause (toggle isRunning)
- [x] Implementar lógica de reset (volver a condiciones iniciales)

### Tarea 6.3: Agregar sliders de posición inicial
- [x] Crear 3 sliders (X, Y, Z)
- [x] Rango: -2 a 2
- [x] Step: 0.01
- [x] Mostrar valor actual al lado de cada slider
- [x] Conectar con estado satelliteState
- [x] Solo permitir modificación cuando isRunning = false

### Tarea 6.4: Agregar sliders de velocidad inicial
- [x] Crear 3 sliders (VX, VY, VZ)
- [x] Rango: -2 a 2
- [x] Step: 0.01
- [x] Mostrar valor actual
- [x] Conectar con estado satelliteState

### Tarea 6.5: Agregar control de timestep y velocidad
- [x] Slider para dt (0.001 - 0.1, step 0.001)
- [x] Slider para velocidad de animación (1x - 100x)
- [x] Conectar con estado

### Tarea 6.6: Agregar selector de sistema binario
- [x] Dropdown o radio buttons para:
  - Sol-Tierra (μ = 3.04e-6)
  - Tierra-Luna (μ = 0.0121)
  - Plutón-Caronte (μ = 0.1089)
- [x] Al cambiar sistema, actualizar mu y recalcular puntos L
- [x] Mover M1 y M2 a nuevas posiciones

### Tarea 6.7: Agregar toggles de visualización
- [x] Checkbox "Mostrar puntos de Lagrange"
- [x] Checkbox "Mostrar trayectoria"
- [x] Conectar con visibilidad de meshes en Scene3D
...
- [x] Crear archivo `src/components/PresetSelector.jsx`
- [x] Diseñar grid de botones con Tailwind
- [x] 4 botones: JWST (L2), Troyano (L4), Inestable (L1), Custom

### Tarea 7.2: Definir condiciones iniciales de presets
- [x] Crear archivo `src/utils/presets.js`
- [x] Definir preset JWST_L2:
  - Sistema: Sol-Tierra
  - x = 1.01, y = 0, z = 0.01
  - vx = 0, vy = 0.1, vz = 0
- [x] Definir preset TROYAN_L4:
  - Sistema: Sol-Tierra
  - Posición cerca de L4
  - Velocidad circular
- [x] Definir preset UNSTABLE_L1:
  - Sistema: Sol-Tierra
  - Posición = L1 + pequeña perturbación
  - Velocidad inicial = 0
- [x] Definir preset LISSAJOUS_L1 (bonus):
  - Órbita de Lissajous cerca de L1

### Tarea 7.3: Conectar presets con Scene3D
- [x] Al hacer click en preset, cargar condiciones iniciales
- [x] Resetear trayectoria
- [x] Pausar simulación
- [x] Actualizar sliders del ControlPanel

### Tarea 7.4: Validar presets
- [x] JWST debe generar órbita de halo estable
- [x] Troyano debe librar alrededor de L4
- [x] Inestable debe escapar de L1
- [x] Verificar conservación de Jacobi en todos los casos
...
- [x] Crear archivo `src/components/InfoPanel.jsx`
- [x] Diseño con Tailwind: panel colapsable en la parte inferior
- [x] Secciones: "Física del Problema", "Constantes de Movimiento", "Ayuda"

### Tarea 8.2: Agregar explicación del CR3BP
- [x] Texto breve explicando el problema de tres cuerpos
- [x] Explicación de qué son los puntos de Lagrange
- [x] Ejemplos reales (JWST, asteroides troyanos)
- [x] Sin fórmulas complejas, lenguaje accesible

### Tarea 8.3: Display de constantes en tiempo real
- [x] Calcular y mostrar:
  - Constante de Jacobi C
  - Energía total
  - Distancias r1, r2
  - Tiempo transcurrido
- [x] Formato: fuente monospace, 4 decimales
- [x] Actualizar cada frame

### Tarea 8.4: Indicador de conservación
- [x] Calcular error relativo en C respecto a C inicial
- [x] Mostrar con código de color:
  - Verde: error < 0.1%
  - Amarillo: 0.1% < error < 1%
  - Rojo: error > 1%
- [x] Advertir si la simulación es inestable numéricamente
...
- [x] Modificar BufferGeometry de trayectoria para usar VertexColors
- [x] Asignar color a cada vértice:
  - Puntos nuevos: blanco (1, 1, 1)
  - Puntos viejos: cyan oscuro (0, 0.5, 0.5)
  - Gradiente lineal según índice
- [x] Usar LineBasicMaterial con vertexColors: true

### Tarea 9.2: Glow en puntos de Lagrange
- [x] Agregar glow visual a L1, L2, L3, L4, L5
- [x] Animar scale con Math.sin(time) para efecto pulsante
- [x] Aplicar a L1, L2, L3, L4, L5
- [x] Intensidad mayor en L4 y L5 (estables)

### Tarea 9.3: Mejorar materiales de los cuerpos
- [x] M1: agregar bloom con emissiveIntensity animado
- [x] M2: agregar especular highlights
- [x] Satélite: agregar trail effect con partículas (opcional)

### Tarea 9.4: Transiciones suaves al cambiar presets
- [x] Implementar interpolación de posición/velocidad
- [x] Duración: 500ms
- [x] Easing: ease-in-out
- [x] Usar requestAnimationFrame para animar

### Tarea 9.5: Responsive design
- [x] Media queries en Tailwind para móviles
- [x] Layout vertical en pantallas < 768px:
  - Canvas arriba (altura fija)
  - Controles abajo (scroll)
- [x] Layout horizontal en pantallas > 768px:
  - Controles a la izquierda (ancho fijo)
  - Canvas a la derecha (flex-1)
- [x] Ajustar tamaño de fuentes y botones

### Tarea 9.6: Loading state
- [x] Mostrar estado de carga mientras se inicializa Scene3D
- [x] Texto: "Inicializando escena 3D..."
- [x] Fade-out al terminar carga
...
- [x] Test 1: Órbita circular de dos cuerpos → C constante
- [x] Test 2: JWST preset → excursión acotada en la escala esperada
- [x] Test 3: Troyano → no escapa de L4 en 1000 periodos orbitales
- [x] Test 4: Error numérico < 0.1% para dt = 0.01
- [x] Validado con `npm run validate:physics`
...
- [x] Sección: Qué es el proyecto
- [x] Sección: Cómo ejecutar localmente
- [x] Sección: Controles y uso
- [x] Sección: Física detrás de la simulación (breve)
- [x] Sección: Tecnologías usadas
- [x] Sección: Referencias y créditos
- [x] Screenshots o GIF demo

### Tarea 12.2: Comentar código crítico
- [x] Comentarios en `rk4.js` explicando el algoritmo
- [x] Comentarios en `cr3bp.js` con las ecuaciones
- [x] Comentarios en `lagrangePoints.js` con la derivación

### Tarea 12.3: Agregar tooltips en la UI
- [x] Hover en puntos L muestra "L1: Punto de Lagrange colineal"
- [x] Hover en sliders muestra rango válido
- [x] Hover en presets muestra descripción breve
...
- [x] Editar `vite.config.js`:
```javascript
export default {
  base: '/tres-cuerpos/',  // nombre del repo
}
```
- [x] Instalar gh-pages: `npm install -D gh-pages`
...
- [x] Verificar tamaño del bundle (< 1MB ideal)

### Tarea 13.3: Deploy
- [x] Ejecutar `npm run deploy`
- [x] Ir a Settings del repo → Pages
- [x] Verificar que la rama gh-pages está seleccionada
- [ ] Esperar ~2 minutos
...
- [x] Generar URL con parámetros: ?preset=jwst&mu=3.04e-6&x=1.01...
- [x] Botón "Copiar enlace"
- [x] Parsear parámetros al cargar la página
